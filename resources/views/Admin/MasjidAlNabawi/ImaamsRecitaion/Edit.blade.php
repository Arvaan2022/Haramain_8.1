            ...
            <div class="row">
                <div class="col-lg-6 col-lg-offset-3 col-xs-12">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <form action="{{ route('nabawi.imaams.recitaion.data.update') }}" id="eid_form" class="form-horizontal"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="select2 form-control" name="imaam_id" id="imaam_id">
                                                <option value="">{{ trans('admin.select_imaam_req') }}</option>
                                                @foreach ($imaam as $ima)
                                                    <option value="{{ $ima->imaam_id }}"
                                                        {{ $ima->imaam_id == $data->imaam_id ? 'selected' : '' }}>
                                                        {{ $ima->imaam_en }}</option>
                                                @endforeach
                                            </select>
                                        </div>
