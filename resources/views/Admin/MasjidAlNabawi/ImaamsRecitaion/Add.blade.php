                ...
                <div class="col-lg-6 col-lg-offset-3 col-xs-12">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <div class="box-title">
                                <h3>{{ trans('admin.add_imaams_recitation') }}</h3>
                            </div>
                        </div>
                        <div class="box-body">
                            <form action="{{ route('admin.nabawi.imaams.recitaion.data.store') }}" id="eit_form" class="form-horizontal"
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control select2" name="surah_id" id="surah">
                                                ...
                                                <option value="{{ $srh->surah_id }}">{{ $srh->surah_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
