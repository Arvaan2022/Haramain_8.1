...
@section('Content')
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class=" menu">
                ...
                <div class="box-header">
                    <div class="box-title pull-right">
                        <a href="{{ route('admin.nabawi.edi.takbeerat.data.add',['id' => $subCatId]) }}" type="button" class="btn btn-success" aria-haspopup="true"
            ...
            <div class="card">
                <div class="card-body">
                    <table id="editakbeeratdata-datatable"
...
@push('JS')
    <script>
        $('#editakbeeratdata-datatable').DataTable({
            processing: true,
            serverSide: true,
            "searching": true,
