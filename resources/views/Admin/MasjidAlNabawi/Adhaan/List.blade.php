            ...
            <div class=" menu">
                ...
                <div class="box-header">
                    <div class="box-title pull-right">
                        <a href="{{ route('admin.nabawi.adhaan.data.add',['id' => $subCatId]) }}" type="button" class="btn btn-success" aria-haspopup="true"
...
@push('JS')
    <script>
        $('#adhaandata-datatable').DataTable({
            processing: true,
            serverSide: true,
            "searching": true,
