                ...
                <div class="col-lg-6 col-lg-offset-3 col-xs-12">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <div class="box-title">
                                <h3>{{ trans('admin.add_tableegh_styles') }}</h3>
                            </div>
                        </div>
                        <div class="box-body">
                            <form action="{{ route('admin.nabawi.tableegh.styles.data.store') }}" id="maudhins_form" class="form-horizontal"
                                ...
                                <div class="form-body">
                                   <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control select2" name="maudhins_id" id="maudhins">
                                                <option value="">{{ trans('admin.select_maudhin') }}</option>
                                                @foreach ($data as $maudh)
                                                <option value="{{ $maudh->maudhins_id }}">{{ $maudh->maudhins_en }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
