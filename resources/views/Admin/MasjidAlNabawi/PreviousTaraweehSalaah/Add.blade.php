                ...
                <div class="col-lg-6 col-lg-offset-3 col-xs-12">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <div class="box-title">
                                <h3>{{ trans('admin.add_pervious_taraweeh_salaah') }}</h3>
                            </div>
                        </div>
                        <div class="box-body">
                            <form action="{{ route('admin.nabawi.previous.taraweeh.salaah.data.store') }}" id="eit_form" class="form-horizontal"
                                ...
                                <div class="form-body">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control select2" name="surah_id" id="surah">
                                                <option value="">{{ trans('admin.select_surah_req') }}</option>
                                                @foreach ($surah as $sur)
                                                <option value="{{ $sur->surah_id }}">{{ $sur->surah_name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
