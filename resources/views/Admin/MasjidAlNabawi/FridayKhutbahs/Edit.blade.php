                ...
                <div class="col-lg-6 col-lg-offset-3 col-xs-12">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <div class="box-title">
                                <h3>{{ trans('admin.edit_friday_khutbahs') }}</h3>
                            </div>
                        </div>
                        <div class="box-body">
                            <form action="{{ route('nabawi.friday.khutbahs.data.update') }}" id="eid_form" class="form-horizontal"
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="select2 form-control" name="language_id" id="language_id">
                                                <option value="">{{ trans('admin.select_language') }}</option>
                                                @foreach ($language as $lang)
                                                    <option value="{{ $lang->language_id }}"
                                                        {{ $lang->language_id == $data->language_id ? 'selected' : '' }}>
                                                        {{ $lang->language_en }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
