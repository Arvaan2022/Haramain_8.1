...
@section('Content')
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class=" menu">
                ...
                <div class="box-header">
                    <div class="box-title pull-right">
                        <a href="{{ route('admin.nabawi.friday.khutbahs.data.add',['id' => $subCatId]) }}" type="button" class="btn btn-success" aria-haspopup="true"
            ...
            <div class="card">
                <div class="card-body">
                    <table id="edikhutbahsdata-datatable"
...
@push('JS')
    <script>
        $('#edikhutbahsdata-datatable').DataTable({
            processing: true,
            serverSide: true,
            "searching": true,
