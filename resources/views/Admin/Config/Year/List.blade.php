                ...
                <section class="content-header">
                    ...
                    <div class="box-header">
                        <div class="box-title pull-right">
                            <a href="{{ route('admin.year.add') }}" type="button" class="btn-info btn" aria-haspopup="true"
                                aria-expanded="false" style="background-color:#549bb2;">
                                <i class="icon-dual icon bi bi-plus-lg"></i>{{ trans('admin.add_year') }}</a>
                        </div>
                    </div>
...
@push('JS')
    <script>
        $('#year-datatable').DataTable({
            ...
            serverSide: true,
            "searching": true,
            ajax: '{{ route('admin.year.list.datatable') }}',
            columns: [{
                    data: 'year_id',
                    sWidth: '10%'
                },
