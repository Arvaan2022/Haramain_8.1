            ...
            <div class=" menu">
                ...
                <div class="box-header">
                    <div class="box-title pull-right">
                        <a href="{{ route('admin.submosque.view') }}" type="button" class="btn btn-success" aria-haspopup="true"
...
@push('JS')
    <script>
        $('#audiodata-datatable').DataTable({
            ...
            serverSide: true,
            "searching": true,
          //  ajax: '{{ url('/nabawi/data/list/datatable/') }}' + subCatId,
             ajax: '{{ route('admin.nabawi.data.list.datatable') }}',
            columns: [{
                    data: 'audio_id',
                    name: 'audio_id',
                    sWidth: '10%'
